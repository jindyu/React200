...
class R126_SoftwareList extends Component {    
            ...
            result.push(
                <tr className="hidden_type">
                    ...
                    <td>
                        ...
                        <a href="#n" className="bt_c1 w50_b" id={data.swt_code} onClick={e => this.deleteSwtool(e)}>삭제</a>
                    </td>
                </tr>
            )
        }
    ...
    render() {
        ...
        return (
            <section className="sub_wrap">
                <article className="s_cnt_mp_pro_li ct1 mp_pro_li_admin">
...
export default R126_SoftwareList
